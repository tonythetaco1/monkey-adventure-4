...
namespace SpriteKind {
    export const teleportationtaco = SpriteKind.create()
    export const teleportationtaco2 = SpriteKind.create()
    export const teleportburger = SpriteKind.create()
    export const teleporatationtaco3 = SpriteKind.create()
    export const TELEPORTATIONTACO4 = SpriteKind.create()
    export const TELEPORTATIONTACO5 = SpriteKind.create()
    export const victorytaco = SpriteKind.create()
}
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.teleporatationtaco3, function (sprite, otherSprite) {
    ...
    mySprite5 = sprites.create(img`
        ...
        .........ccccccccc..ccc.
        `, SpriteKind.Enemy)
    mySprite2.setKind(SpriteKind.TELEPORTATIONTACO4)
    mySprite2.setPosition(97, -3)
    mySprite4.setPosition(157, 70)
    mySprite5.setPosition(156, 30)
    mySprite4.follow(mySprite)
    mySprite5.follow(mySprite)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.teleportationtaco2, function (sprite, otherSprite) {
    max_jumps = 2
    mySprite2.destroy()
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.victorytaco, function (sprite, otherSprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.TELEPORTATIONTACO5, function (sprite, otherSprite) {
    ...
    scene.setBackgroundImage(img`
        ...
        7777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
        `)
    mySprite.sayText("Now i can eat the taco!")
    mySprite2.setKind(SpriteKind.victorytaco)
    mySprite2.setPosition(79, 121)
})
...
info.onCountdownEnd(function () {
    mySprite3.destroy()
    game.showLongText("JUMP TO THE TELEPORTATION TACO", DialogLayout.Bottom)
    music.baDing.play()
    mySprite2.setPosition(58, 121)
    mySprite2.setKind(SpriteKind.teleporatationtaco3)
    mySprite2 = sprites.create(img`
        ...
        . 4 5 4 5 5 4 e . . . . . . . . 
        . . 4 4 e e e . . . . . . . . . 
        `, SpriteKind.teleporatationtaco3)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.teleportationtaco, function (sprite, otherSprite) {
    max_jumps = 1
    mySprite2.setKind(SpriteKind.teleportationtaco2)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.TELEPORTATIONTACO4, function (sprite, otherSprite) {
    mySprite4.destroy()
    mySprite5.destroy()
    tiles.setCurrentTilemap(tilemap`level lava`)
    scene.setBackgroundColor(4)
    mySprite2.setKind(SpriteKind.TELEPORTATIONTACO5)
    mySprite2.setPosition(8, 80)
...
mySprite = sprites.create(assets.image`MONKE`, SpriteKind.Player)
controller.moveSprite(mySprite, 100, 0)
tiles.setCurrentTilemap(tilemap`side1`)
scene.cameraFollowSprite(mySprite)
mySprite.setPosition(79, 120)
mySprite.ay = 350
mySprite2 = sprites.create(assets.image`teleportation taco`, SpriteKind.teleportationtaco)
game.showLongText("TOUCH THE TELEPORTATION TACO", DialogLayout.Bottom)
mySprite2.setPosition(16, 84)
number_of_jumps = 0
max_jumps = 1
